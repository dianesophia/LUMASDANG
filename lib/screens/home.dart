        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              height: 20,
              decoration: BoxDecoration(
                color: _selectedValue == true ? widget.color : widget.color.withOpacity(0.25),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              height: 20,
              decoration: BoxDecoration(
                color: _selectedValue == false ? widget.color : widget.color.withOpacity(0.25),
                border: Border.all(color: widget.color, width: 1.5),
                borderRadius: BorderRadius.circular(3),
              ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: selectedDose != null
                ? const Color(0xFF2E8B7B).withOpacity(0.18)
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 11,
                              color: const Color(0xFF2E8B7B).withOpacity(0.9),
                              fontWeight: FontWeight.w500,
                            ),
                          ),
                        ),
