...
class _VaccinationStatusSectionState
  ...
  int get _completedCount =>
      _statuses.values.where(_isCompleted).length;
  bool get _allCompleted =>
      _statuses.values.every(_isCompleted);
  ...
  Widget _buildBody() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          _datePill(
              'Last Review: ${_formatDate(_lastReviewDate)}'),
          if (_lastModifiedByName != null &&
              widget.useSharedStorage) ...[
          ...
          const Text('IMMUNIZATION RECORD',
              style: TextStyle(
                  fontSize: 10,
                  fontWeight: FontWeight.w700,
                  color: _inkMid,
  ...
  Widget _datePill(String label) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(30),
          border: Border.all(
              color: _orange.withOpacity(0.20), width: 1),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Column(
                    ...
                    children: [
                      const Text('Update Vaccination Record',
                          style: TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.w700,
                              color: _ink)),
              ...
              Flexible(
                child: ListView(
                  ...
                  children: _vaccines.map((v) {
                    ...
                    final dropVal = (current == 'Completed' &&
                            !v.possibleDoses
                                .contains('Completed'))
                        ? v.possibleDoses.last
                        : (v.possibleDoses.contains(current)
                            ? current
